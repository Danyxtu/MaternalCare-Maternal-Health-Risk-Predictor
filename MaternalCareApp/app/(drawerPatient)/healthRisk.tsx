...
import { getPatientRiskStyles } from "#/src/styles/patientRisk.styles";
...
const HealthRiskScreen: React.FC = () => {
  ...
  const prediction =
    aiResult?.predicted_class || aiResult?.prediction || "Low Risk";
  ...
  const getRiskDetails = () => {
    ...
    if (level.includes("high")) {
      return {
        ...
        description:
          "Your recent vitals indicate a high risk level. Please contact your healthcare provider immediately for further guidance.",
      };
      ...
      return {
        ...
        description:
          "Your vitals show a moderate risk. We recommend scheduling a follow-up consultation with your doctor soon.",
      };
    } else {
      return {
        color: "#10B981",
        ...
        description:
          "Your vitals are within the normal range. Keep maintaining your healthy lifestyle and regular checkups.",
      };
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={[styles.resultCard, { backgroundColor: risk.color }]}>
          ...
          <View style={styles.riskIconContainer}>{risk.icon}</View>
        </View>

        <View style={styles.explanationCard}>
          <Text style={styles.sectionTitle}>Medical Guidance</Text>
          <Text style={styles.explanationText}>{risk.description}</Text>
        </View>

        <View style={styles.explanationCard}>
          <Text style={styles.sectionTitle}>What does this mean?</Text>
          <Text style={styles.explanationText}>
            This assessment is based on your blood pressure, sugar levels,
            temperature, and heart rate using our advanced AI monitoring system.
            It helps identify potential concerns early in your pregnancy.
          </Text>
        </View>
