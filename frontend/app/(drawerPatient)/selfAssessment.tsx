  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: isDark ? '#0F172A' : '#FFFFFF' }}>
      <View style={{ flexDirection: "row", alignItems: "center", padding: 20 }}>
        ...
        <Text style={{ marginLeft: 16, fontSize: 20, fontWeight: "700", color: isDark ? '#F1F5F9' : '#1E293B' }}>Self Assessment</Text>
      </View>
      ...
      <View style={{ flex: 1, alignItems: "center", justifyContent: "center", padding: 40 }}>
        ...
        <Text style={{ marginTop: 12, fontSize: 16, color: "#64748B", textAlign: "center", lineHeight: 24 }}>
          We are currently building this feature to help you track your health daily. Check back soon!
        </Text>
      </View>
    </SafeAreaView>
  );
